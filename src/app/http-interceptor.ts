...
export function applicationHttpClientCreator(http: HttpClient, errorHandler: GlobalErrorHandler) {
...
export class ApplicationHttpClient {
    ...
    public constructor(public http: HttpClient, private errorHandler: GlobalErrorHandler) {
    ...
    public post<T>(endPoint: string, params: Object, options?: IRequestOptions): Observable<T> {
        return this.http.post<T>(this.api + endPoint, params, options).catch(this.handleError);
    }
